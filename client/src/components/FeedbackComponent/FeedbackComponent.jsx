                    ...
                    <div class="col-lg-6 col-md-6 p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5 p-xxl-5 m-0 ">
                        ...
                        <div id={styles.carouselExampleSlidesOnly} class="carousel slide  me-0  p-2 p-sm-4 p-md-4 p-lg-4 p-xl-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class={`carousel-item ${styles.vikas}`}>
                                    <img src={img3} width="100px" height="100px" class="rounded-circle m-2" alt=""/>
                                    <span class={styles.nameheading}>John Duo</span><br />
                                        <span class={styles.stars}>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                ...
                                <div class={`carousel-item ${styles.vikas}`}>
                                    <img src={img3} width="100px" height="100px" class="rounded-circle m-2" alt=""/>
                                    <span class={`${styles.nameheading} ${styles.vikas}`}>Smith Thomson</span><br />
                                        <span class={`${styles.stars} ${styles.vikas}`}>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                        ...
                        <svg class="mt-3" width="36" height="36" viewBox="0 0 36 36" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <button class="btn d-block mt-5" id={styles.btnColor}>DISCOVER MORE</button>
                    </div>
