...
<section>
            <div className="container-md-fluid container-lg  mt-5 mb-5">
                <div className={`row ${styles.aboutSecSection} rounded-4 `}>
                    ...
                    <div className="col-lg-6 col-md-6 p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5 p-xxl-5 m-0 ">
                        <svg className="mt-4" width="36" height="35" viewBox="0 0 36 35" fill="none"
                        ...
                        <div id={styles.carouselExampleSlidesOnly} className="carousel slide  me-0  p-2 p-sm-4 p-md-4 p-lg-4 p-xl-4" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className={`carousel-item active ${styles.vikas}`}>
                                    <img src={img3} width="100px" height="100px" className="rounded-circle m-2" alt=""/>
                                        <span className={styles.nameheading}>Jack Jackson</span>
